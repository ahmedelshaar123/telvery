@extends('layouts.admin.app',[
            ...
            'page_description'       => trans("admin.governorates"),
                                ])
@section('content')
                    ...
                    <table class="data-table table table-bordered" id="table1">
                        ...
                        @foreach($governorates as $governorate)
                            <tr id="removable{{$governorate->id}}">
                                ...
                                <td class="text-center"><a href="{{route('governorates.edit', $governorate->id)}}"
                                                           class="btn btn-xs btn-success"><i class="fa fa-edit"></i></a>
                                </td>
                                <td class="text-center">
                                    <button data-token="{{ csrf_token() }}"
                                            data-route="{{URL::route('governorates.destroy',$governorate->id)}}"
